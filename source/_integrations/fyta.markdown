...
The integration should work with any [FYTA Sensor](https://fyta.de/pages/fyta-system). Only the data provided by the respective sensor is displayed.

## Prerequisites

For the integration to work you need a [FYTA Sensor](https://fyta.de/pages/fyta-system) and a FYTA account. Link the sensor to a plant to show the information in Home Assistat. 
